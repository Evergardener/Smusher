...
////Smusher////////////////////////////////////////////////////////////////////////////////////////////
	...
	if($smusher_data = getPlugin('Smusher')){
		$smusher_directory = dirname($smusher_data->filenameMetadata);
		$config = json_decode(file_get_contents($smusher_directory . DS . 'settings' . DS . 'settings.json'), true);
		if($config['disable'] !== 1){
			include($smusher_directory . DS . 'smusher.php');
		}
	}
//////Smushy out////////////////////////////////////////////////////////////////////////////////////////
